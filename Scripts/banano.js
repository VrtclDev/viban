...
(function() {
  ...
  const getAccountHistory = async (account, count, head, raw, filter, offset) => {
    /* istanbul ignore if */
    if (account === undefined) {
      throw Error(`'account' is a required parameter.`);
    }
    ...
    if (filter !== undefined) {
      formData.account_filter = filter;
    }
...
const withdrawRaw = async (
  ...
  const exports = (() => {
    ...
    exports.withdrawRaw = withdrawRaw;
    return exports;
  })();
...
const sendRawBananoWithdrawalFromSeed = async (
      seed,
      seedIx,
      toAccount,
      amountRaw,
    ...
    const response = withdrawUtil.withdrawRaw(
        loggingUtil,
        bananodeApi,
        privateKey,
        toAccount,
   ...
   */
  const getAccountHistory = async (account, count, head, raw, filter) => {
    return await bananodeApi.getAccountHistory(account, count, head, raw, filter);
  };
  ...
  const exports = (() => {
    ...
    exports.sendRawBananoWithdrawalFromSeed = sendRawBananoWithdrawalFromSeed;
    exports.getAccountsPending = getAccountsPending;
